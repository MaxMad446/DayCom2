...
def main():
    ...
    global _commits_per_day
    _commits_per_day = random.randint(3, 8)
    ...
    while True:
        try:
            ...
            print(f"Generating {_commits_per_day} commits for today")
            
            # Generate multiple commits
            for i in range(_commits_per_day):
                ...
                print(f"Commit {i+1}/{_commits_per_day} completed at {commit_time_str}")
